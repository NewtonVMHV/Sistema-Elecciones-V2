...
<section class="container">
    ...
    <div class="alert alert2 alert-danger" role="alert">
        La estructuta no existe, <a href="{{ route('Estructura.create') }}" class="alert-link">¡Crealo!</a>
    </div>
        ...
        <div class="row mb-4">
            <div class="col">
                <div class="form-outline">
                    ...
                    <input type="text" name="clave" id="clave" class="form-control" value="{{ $gestiones->clave }}" onblur="buscar_datos();" required/>
                    <ul>
